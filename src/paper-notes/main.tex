...
semi-monolithic NN positioning (\ref{note:Freire2022NN}) and monolithic BGO.
...
\begin{papernote}{Freire et al.\ 2022 -- Position estimation using neural networks in semi-monolithic PET detectors}{Freire2022NN}
\thumb{img/freire2022position.png}
...
tube of \ref{note:i3MTube}: a flat semi-monolithic detector for total-body PET
...
contest with \ref{prog:Ghent} as well as the annular one with
...
\gap{The positioning method and the resolution it reached.}
...
\thumb{img/wilson2020optimisation.png}
