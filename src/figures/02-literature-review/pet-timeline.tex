...
%
% Labels still go on their own layer, drawn after the leaders and filled with
% the page colour, as a backstop. The fill must track the theme -- hardcoded
% white would sit as a bright block on a dark page and, worse, would stop
% masking the leaders it exists to mask.
