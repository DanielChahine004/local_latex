...
% one, drop an \acr line anywhere below -- order does not matter, the list is
% sorted case-insensitively when printed (expl3, no packages -- datatool was cut
% because its load-and-sort cost helped push Overleaf past its compile timeout).
