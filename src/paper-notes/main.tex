...
%
% \location[dx,dy]{lat}{lon}{Place} right after \begin{programnote} pins the
% programme on the map; [dx,dy] fixes its panel's offset from the pin in
% pixels, and without it the panel finds a free spot on its own.
%
